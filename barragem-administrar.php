              ...
              <table class="table datatable">
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td><center><a href="<?php echo INCLUDE_PATH ?>barragem-validar.php?codBarragem=<?php echo $value['cod_barragem']; ?>"><i class="bi bi-pencil-square"></i></a>&nbsp;&nbsp;<a href="<?php echo INCLUDE_PATH ?>barragem-infor-adicional.php?codBarragem=<?php echo $value['cod_barragem']; ?>"><i class="bi bi-clipboard-plus"></i></a>&nbsp;&nbsp;<a href=""><i class="bi bi-printer"></i></a></center></td>
                  </tr>
                  <?php
                    }
                    ?>
